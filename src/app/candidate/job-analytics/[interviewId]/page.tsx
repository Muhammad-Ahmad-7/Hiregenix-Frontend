...
type ReportResponse = {
    ...
    report: InterviewOverallAnalysis | null;
};
...
export default function CandidateInterviewReportPage({
    params,
}: {
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
                <div className="candidate-report-hero overflow-hidden rounded-[28px] border border-white/30 bg-white/90 p-5 shadow-[0_20px_50px_rgba(15,23,42,0.08)] backdrop-blur md:p-6">
                    ...
                    <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <Link href="/candidate/job-analytics" className="shrink-0">
                            <Button type="default" size="large" className="candidate-report-secondary-btn">
                                All Interviews
                            </Button>
                        </Link>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col gap-6">
                        {isEvaluationOnly ? (
                            ...
                            <Card
                                ...
                                title={
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-base font-semibold">Overall Report</span>
                                    </div>
                                }
                            >
                                <div className="grid gap-4 xl:grid-cols-3">
                                    ...
                                    <div className="candidate-report-panel candidate-report-panel--improvements rounded-2xl p-4">
                                        <div className="mb-3 flex items-center gap-2 text-sky-700">
                                            <PlayCircleOutlined />
                                            <span className="font-semibold">Improvement Suggestions</span>
                                        </div>
                                        {renderList(data.report.overallImprovementSuggestions)}
                                    </div>
                                </div>
                            </Card>
                        ) : (
                            <Card className="candidate-report-card rounded-[24px] border-0">
                                <Empty
                                    description="No overall report was returned for this interview yet."
                                />
                            </Card>
                        )}
                        ...
                        <Card
                            className="candidate-report-card rounded-[24px] border-0"
                            title={<span className="text-base font-semibold text-slate-900">Question Results</span>}
                        >
                                                        ...
                                                        <div className="grid gap-4 lg:grid-cols-2">
                                                            <div className="space-y-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <Paragraph className="candidate-report-text mt-2 !mb-0">
                                                                        <Tag className="mb-2 rounded-full px-3 py-1 text-sm">
                                                                ...
                                                                <div className="grid gap-3 md:grid-cols-2">
                                                                    <div className="candidate-report-mini-card rounded-2xl p-4">
                                                                        ...
                                                                        <div className="mt-3">{renderList(question.lLMAnalysis?.insights?.strengths)}</div>
                                                                    </div>
                                                                    <div className="candidate-report-mini-card rounded-2xl p-4">
                                                                        <Text strong>Weaknesses</Text>
                                                                        <div className="mt-3">{renderList(question.lLMAnalysis?.insights?.weaknesses)}</div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="candidate-report-mini-card rounded-2xl p-4">
                                                                    ...
                                                                    <div className="mt-3">
                                                                        {renderList(question.lLMAnalysis?.insights?.improvementSuggestions)}
                                                                    </div>
                                                                </div>
                                                            </div>
